...
app.layout = html.Div([
    ...
    html.H1("Automobile Statistics Dashboard", style={'color':'#503D36, 'font-size':24}), #May include style for title
...
# Define the callback function to update the input container based on the selected statistics
@app.callback(
    Output(component_id='ouput-container', component_property='children'),
    [Input(component_id='select-year', component_property='value'), Input(component_id='dropwdown-statistics', component_property='value')])
