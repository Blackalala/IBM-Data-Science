...
# Plot 4 bar chart for the effect of unemployment rate on vehicle type and sales
        ...
        R_chart4 = dcc.Graph(figure=px.histogram(emp_rec, x='Vehicle_Type',y='Automobile_Sales', color='unemployment_rate',
...
# TASK 2.6: Create and display graphs for Yearly Report Statistics
 # Yearly Statistic Report Plots                             
    elif (input_year=='Select Year' and selected_statistics=='Recession Period Statistics') :
...
# Plot 2 Total Monthly Automobile sales using line chart.
        ...
        Y_chart4 = dcc.Graph(figure=px.histogram(exp_data, x='Vehicle_Type',y='Automobile_Sales', color='unemployment_rate',
